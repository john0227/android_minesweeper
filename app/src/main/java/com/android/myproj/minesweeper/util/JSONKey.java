...
public class JSONKey {
    ...
    // EASY Level Stats
    public static final String KEY_STAT_EASY_GAMES_STARTED = "easy_games_started";     // long
    public static final String KEY_STAT_EASY_GAMES_WON = "easy_games_won";             // long
    public static final String KEY_STAT_EASY_WIN_RATE = "easy_win_rate";               // int (0 - 100)
    public static final String KEY_STAT_EASY_BEST_TIME = "easy_best_time";             // long (MM:SS -> MM * 60 + SS)
    public static final String KEY_STAT_EASY_AVERAGE_TIME = "easy_average_time";       // long (same as above)
    public static final String KEY_STAT_EASY_BEST_STREAK = "easy_best_win_streak";     // long
    public static final String KEY_STAT_EASY_CURR_STREAK = "easy_current_win_streak";  // long
    public static final String KEY_STAT_EASY_NO_HINT_WINS = "easy_wins_with_no_hint";  // long
